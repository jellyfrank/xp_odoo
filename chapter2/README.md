...
默认情况下，在勾选了上面的设置之后，我们在销售订单中可以看到客户的详细地址， 如下图所示：

![客户详细地址](images/61.png)

如果我们想要同时把开票地址和送货地址也像客户地址那样显示出来该怎么办呢？技术上很简单，但是对于不懂技术的用户来说就有点麻烦。因此，我们在[欧姆通用解决方案](https://book.odoomommy.com/chapter8/SECTION.html)中对此加入了选项支持。

用户在设置-销售设置-报价单&销售订单设置中，勾选"显示发票地址"和"显示发货地址"两个选项即可。
...
欧姆网络科技提供报表文件的修改及设计服务，如有需要欢迎联系客服进行咨询。
