...
启用变体之后，可以在菜单中看到两个菜单，一个叫产品，一个叫产品变体。从技术角度讲，对应于两个不同的技术模型。产品模板对应的是product.template，产品变体对应的是product.product。 我们先来看产品模板：
...
销售价格，产品的销售价格。默认只有一个销售价格，如果需要更多的价格，可以使用价格表的功能。
